...
wheel with no projection at all.
...
| `barrelProperties` | `BarrelProperties` | `WheelPickerDefaults.barrelPropertiesFor(rowCount)` | Rim angle of the cylindrical row projection. See [Barrel projection](#barrel-projection) |
